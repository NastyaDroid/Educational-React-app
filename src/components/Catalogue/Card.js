...
const Card = ( { card } ) => {
    return (
        <div key={card.objectID} className='product-card'>
            ...
            <svg className="product__cart-img" width="20" height="20" viewBox="0 0 20 20" fill="#5AC36B" xmlns="http://www.w3.org/2000/svg">
